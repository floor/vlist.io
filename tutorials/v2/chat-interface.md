...
- [Groups Plugin](/docs/v2/plugins/groups) — Add date headers to chat UIs
- [Data Plugin](/docs/v2/plugins/data) — Infinite scrolling with async loading
- [Selection Plugin](/docs/v2/plugins/selection) — Add message selection
- [API Reference](/docs/v2/api) — Full API documentation
