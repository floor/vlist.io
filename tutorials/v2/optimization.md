...
If you're curious about how vlist works internally, see [Internals: Optimization](/docs/v2/internals/optimization).
...
- [Internals: Optimization](/docs/v2/internals/optimization) — How pooling, the pipeline, and scroll handling work under the hood
- [Data Plugin](/docs/v2/plugins/data) — Sparse storage, chunking, and async loading
- [AutoSize Plugin](/docs/v2/plugins/autosize) — Auto-measure items via ResizeObserver
