...
- **[Getting Started](/docs/v2/getting-started)** — Installation, configuration, TypeScript
- **[Plugins](/docs/v2/plugins/overview)** — All plugins with examples
- **[API Reference](/docs/v2/api)** — Complete method and event reference
