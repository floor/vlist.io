...
- **[Plugins Overview](/docs/v2/plugins/overview)** — All plugins with correct API
- **[Grid](/docs/v2/plugins/grid)** · **[Groups](/docs/v2/plugins/groups)** · **[Data](/docs/v2/plugins/data)**
- **[Selection](/docs/v2/plugins/selection)** · **[Scale](/docs/v2/plugins/scale)** · **[Scrollbar](/docs/v2/plugins/scrollbar)**
- **[API Reference](/docs/v2/api)** — Complete method reference
