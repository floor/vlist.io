...
- [Carousel Plugin Reference](/docs/v2/plugins/carousel) — Full API documentation
- [Carousel Example](/examples/carousel) — Live interactive demo
- [Plugin System Tutorial](/tutorials/v2/plugin-system) — Understanding how plugins work
- [Plugin Authoring Tutorial](/tutorials/v2/plugin-authoring) — Writing your own plugins
