// benchmarks/suites/scroll/react/suite.js — Scroll FPS Benchmark (React)
//
// Thin wrapper around the shared engine scroll measurement.
// Defines the React create/destroy lifecycle, calls engine functions,
...
defineSuite({
  ...
  run: async ({
    ...
    // =====================================================================
    // Phase 4: Create React component and measure scroll performance
    // =====================================================================
    container.innerHTML = "";
