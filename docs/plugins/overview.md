...
| scale | `scale()` | +{{size:scale:delta}} KB | **Deprecated** — use `scroll: { mode: "bounded" }` in 2.x or synthetic mode from `vlist/synthetic`; removed in 3.0. See [Scroll modes](/docs/scroll-modes) |
