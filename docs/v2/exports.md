...
>
> For the core API (config, methods, events), see [API Reference](./api.md). For a plugin authoring guide, see [Plugin Authoring tutorial](/tutorials/v2/plugin-authoring).
