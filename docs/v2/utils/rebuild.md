...
2. **Create** — Calls your factory with a pre-configured [snapshots](/docs/v2/plugins/snapshots) plugin
...
You don't need to import or configure the [snapshots](/docs/v2/plugins/snapshots) plugin yourself.
