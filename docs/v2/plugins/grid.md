...
Combine with [scale](/docs/v2/plugins/scale) for grids with 1M+ items. Compression is handled automatically — range calculation and item positioning switch to viewport-relative mode when the total content height exceeds the browser limit.
