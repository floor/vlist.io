...
Combine with [scale](/docs/v2/plugins/scale) for tables with 1M+ rows. Compression is handled automatically — the table switches to compressed range calculation and viewport-relative row positioning when content exceeds the browser limit.
